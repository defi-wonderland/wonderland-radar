...
const Radar = function (size, radar) {
  ...
  function plotRadarFooter() {
    d3.select('body')
      ...
      .append('p')
      .html(
        '<a href="https://wonderland.xyz">Wonderland</a> Technology Radar. ' +
          'Based on <a href="https://github.com/thoughtworks/build-your-own-radar">Build Your Own Radar</a> ' +
          'by <a href="https://www.thoughtworks.com">ThoughtWorks</a>, ' +
          'licensed under <a href="https://github.com/thoughtworks/build-your-own-radar/blob/main/LICENSE">AGPL-3.0</a>.',
      )
  }
